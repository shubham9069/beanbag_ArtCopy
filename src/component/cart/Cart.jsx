...
const Add_to_cart= async(id,qty,type) =>{
  ...
  return (
    ...
    <h6 style={{fontSize: '22px',color:'#fb7676'}}> Your Cart Is Empty</h6>
        ...
        return <div className='row' style={{ border: '1px solid #C7C5C5', padding: '20px 0px 20px 0 ',borderRadius:'10px',marginBottom:'1rem' }}>
            ...
            <div className='col-md-9' style={{ marginTop: 15, position: 'relative' }}>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-2 filterForm' style={{border: '1.5px solid #fb7676'}}>
...
<option>08"X10"</option>
                ...
                <div className='col-md-2 d-flex align-items-center ' style={{margin:'0 0 0 auto'}}>
                        <div style={{fontSize: 16,fontWeight:600,color:"#fb7676"}}>₹{element?.product?.price}<span style={{ textDecoration: 'line-through', fontSize: 12}}> ₹30000 </span></div>
...
<div className='section section-marginY section-padding' style={{ backgroundColor: 'rgba(255, 206, 206, 0.39)' }}>
...
<label className="custom-control-label px-3 coupan-lable" for="customCheck1">
  ...
  <pdesc style={{fontSize:'12px', fontWeight:600}}>Save <span style={{color: '#fb7676'}}>{element?.type==1 && (element?.discount)+" Rs" || element?.type==2 && (element?.discount)+" %" || element?.type==3 && "UPTO "+(element?.discount)+" Rs" || element?.type==1 && "UPTO "+(element?.discount)+" %"  } off on Product price </span></pdesc>
</label>
</div>
