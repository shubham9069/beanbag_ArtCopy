      ...
      <div className='row' style={{ border: '1px solid #C7C5C5', padding: '20px 0px 20px 0 ',borderRadius:'10px',marginBottom:'1rem' }}>
          ...
          <div className='col-md-9' style={{ marginTop: 15, position: 'relative' }}>
              ...
              <div className='row'>
                  ...
                  {/* <div className='col-md-2 filterForm' style={{border: '1.5px solid #f8adad'}}>
              ...
              <div className='col-md-2 d-flex align-items-center ' style={{margin:'0 0 0 auto'}}>
                      <div style={{fontSize: 16,fontWeight:600,color:"#f8adad"}}>₹{element?.price}<span style={{ textDecoration: 'line-through', fontSize: 12}}> ₹30000 </span></div>
...
<label className="custom-control-label px-3 coupan-lable" for="customCheck1">
  ...
  <pdesc style={{fontSize:'12px', fontWeight:600}}>Save <span style={{color: '#f8adad'}}>{element?.type==1 && (element?.discount)+" Rs" || element?.type==2 && (element?.discount)+" %" || element?.type==3 && "UPTO "+(element?.discount)+" Rs" || element?.type==1 && "UPTO "+(element?.discount)+" %"  } off on Product price </span></pdesc>
</label>
</div>
