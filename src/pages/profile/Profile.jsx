...
<h4 id="below650" onClick={()=>setToggle(!Toggle)}> Setting</h4>
    <div className='d-flex section-margin justify-content-between' id="main-div-right" >
        <div className='col-md-2' id="above650">
            ...
            <h5>Setting</h5>
            <div className='darkLink profileLink' href='#' style={{ color: tab === 1 ? "#ec1312" : '#000', display: 'flex', flexDirection: 'row', alignItems: 'center', margin: 15 }}
                onClick={() => setTab(1)}>
                <i class="bi bi-person" style={{ marginRight: 20, fontWeight: 'bold', fontSize: 18 }}></i>
                User info
            </div>
            {/* <div className='darkLink profileLink' href='#' style={{ color: tab === 3 ? "#ec1312" : '#000', display: 'flex', flexDirection: 'row', alignItems: 'center', margin: 15 }}>
                <i class="bi bi-star" style={{ marginRight: 20, fontWeight: 'bold', fontSize: 18 }}></i>
                Watchlist
            </div> */}
            {/* <div className='darkLink profileLink' href='#' style={{ color: tab === 4 ? "#ec1312" : '#000', display: 'flex', flexDirection: 'row', alignItems: 'center', margin: 15 }}
            onClick={() => setTab(4)}>
                <i class="bi bi-heart" style={{ marginRight: 20, fontWeight: 'bold', fontSize: 18 }}></i>
                Account
            </div> */}
            <a className='darkLink profileLink'  style={{ color: tab === 5 ? "#ec1312" : '#000', display: 'flex', flexDirection: 'row', alignItems: 'center', margin: 15 }}
                onClick={() => setTab(5)}>
