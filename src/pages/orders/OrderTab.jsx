...
{!AllOrder?.length ? 
    ...
    <img src="/images/orderEmpty.png" alt="no-item" style={{ maxHeight: 250, maxWidth: 200,width:'80%',textAlign:'center',width:'100%' }}></img>
            ...
            <div className='container section-padding' style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                return   <div  style={{
                   ...
                   <div style={{ display: 'flex', }}>
                           ...
                           {element?.status==0? <p style={{margin: '0 10px 0 auto',fontSize:12}}>Ordered Cancelled</p>:<p style={{margin: '0 10px 0 auto',fontSize:12,cursor:'pointer',color:'grey'}} onClick={()=>{setcancelOrder(element?.id);setShow(true)}}>Cancel Order</p>}
                        </div>
