     ...
     <div className='center-div'>
                <div className='section-margin form-rightW1000' style={{ padding: 0}}>
                    <form className=' inputForm'
                        ...
                        <br></br>
                        <p style={{ color: '#000', textAlign: 'center' }}><a href="#/login" className='link-a ' style={{color:'#fb7676'}} ><i class="bi bi-arrow-left px-2" style={{color:'#fb7676',fontSize:15}}></i>Back to login</a></p>
