             ...
             <div className="center-div">
                <div className=' form-rightW1000 section-margin' style={{ padding: 0}}>
                    <form className=' inputForm' onSubmit={signup} 
                        ...
                        <h3>Welcome to Bean Bag</h3>
                        <span style={{fontWeight:600,color:'#757373b0'}}>Create your account and go to <Link to="/" className='link-a' style={{color:'#fb7676'}}>Home</Link></span>
                        <br></br>
                        <br></br>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', margin: '15px 0px 0px 20px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1.5px solid #aaa', height: 20, width: 20, borderRadius: 3, marginRight: 10, cursor: 'pointer' }}
                                ...
                                {selected ?
                                    <i class="bi bi-check-lg" style={{ color: '#fb7676' }}></i>
                                    : null}
                            </div>
                            <p style={{ color: '#000', textAlign: 'center', margin: 0,fontWeight:600 }}>I agree to the <Link to='/Terms_&_condition' className='link-a' style={{fontWeight:600,color:'#fb7676'}}>Terms & Conditions</Link></p>
                        </div>
                        <button type='submit' className='themeButton' style={{ width: '100%', marginTop: 20 }}>Sign up</button>
                        <br></br>
                        <p style={{ color: '#000', textAlign: 'center',fontWeight:500,letterSpacing: '-0.017em'  }}>Are you already a member ? <a href="#/login" className='link-a' style={{color: '#fb7676'}}>Log in</a></p>
