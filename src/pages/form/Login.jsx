               ...
               <div className="center-div">
                <div className=' form-rightW1000 section-margin' style={{ padding: 0 }}>
                    ...
                    <form className=' inputForm' onSubmit={login}
                        ...
                        <span style={{fontWeight:600,color:'#757373b0'}}>Log in and  go to the <Link to="/" className='link-a' style={{color:'#fb7676'}}>Home</Link></span>
                        <br></br>
                        <br></br>
                        ...
                        <br></br>
                        <p style={{ color: '#000', textAlign: 'center',fontWeight:500,letterSpacing: '-0.017em' }}>Don't have an account? <Link to="/signup" className='link-a' style={{color: '#fb7676'}}>Sign up</Link></p>
