    ...
    <div className="center-div">
                ...
                <div className='section-margin  form-rightW1000' style={{ padding: 40 }}>
                    <form className='otpform' onSubmit={checkotp} 
                        ...
                        <p style={{ color: '#000',fontWeight:500 }}>Log In using <a href="#/login" className='link-a' style={{color:'#fb7676'}}>Password</a></p>
                        <p style={{ color: '#000',fontWeight:500  }}>Having trouble in logging in? <a href="#" className='link-a'  style={{color:'#fb7676'}}>Get Help</a></p>
                        <br></br>
